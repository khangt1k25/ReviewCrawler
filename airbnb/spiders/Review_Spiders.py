...
from ..itemsloader import AirbnbLoader
...
class ReviewSpider(CrawlSpider):
    ...
    def parse_review(self, response):
        ...
        for review in reviews:
            loader = AirbnbLoader(AirbnbItem())
            loader.add_value("review_id", review['id'])
            loader.add_value("reviewer_id", review['reviewer']['id']),
            loader.add_value("reviewee_id", review['reviewee']['id']),
            loader.add_value("text", review['comments'])
            loader.add_value("rating", review['rating'])
            loader.add_value("date", review['createdAt'])
